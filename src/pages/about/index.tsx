...
export default function AboutPage() {
  return (
    <>
      <Meta
        pageTitle='Cocktail Parola - このサイトについて'
        pageDesc='カクテル言葉紹介サイト「Cocktail Parola」のAboutページです'
      />
      <Box>
        ...
        <Box sx={{ backgroundColor: 'primary.contrastText', p: 2, mt: 3, borderRadius: '10px' }}>
